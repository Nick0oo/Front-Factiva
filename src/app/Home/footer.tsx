...
export default function FooterSection() {
    return (
        <footer className="py-2 md:py-10">
            <div className="mx-auto max-w-5xl px-6">
                

                <div className="my-8 flex flex-wrap justify-center gap-6 text-md">
                ...
                <div className="my-8 flex flex-wrap justify-center gap-6 text-sm">
                    ...
                    <Link
                        href="https://www.facebook.com/PYCE2001"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="Facebook"
                        className="text-muted-foreground hover:text-white block">
                    ...
                    <Link
                        href="https://www.instagram.com/ren.tech.1?igsh=NTYc3l0eDUwdHRs"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <Link
                        href="https://www.tiktok.com/@ren.tech4?_t=ZS-8w21GaULAq9&_r=1"
                        target="_blank"
                        rel="noopener noreferrer"
                        aria-label="TikTok"
                        className="text-muted-foreground hover:text-white block">
                ...
                <span className="text-white block text-center text-sm"> © {new Date().getFullYear()} RENTech, Todos los derechos reservados</span>
            </div>
        </footer>
    )
}
